@extends('layouts.menuPage')
@section('content')
      <section class="hero bg-img-franchise position-relative">
        <div class="container-fluid">
          <div class="row">
            <div class="col-12 col-md-6 d-flex flex-column cta">
              <h1 class="font-weight-bold avenirltstd-light text-white" style="text-shadow: 2px 2px 4px #000000;">“Pour ma vue aussi, je demande conseil à mon Pharmacien”</h1>
      ...
      <section class="container-fluid">
        <h2 class="text-uppercase text-title text-center pt-md-5 pb-4 mb-5 avenirltstd-light">“Pour ma vue aussi, je demande conseil à mon Pharmacien”</h2>
        <div class="row">
          <div class="col-md-4">
            <div class="shadow-sm p-4 text-center mb-4 boder box-hover" style="height: 400px;">
              <i class="fas fa-sync-alt i-fas mb-4 icone-color"></i>
              <h5 class="text-uppercase avenirltstd-light">Ma vue, ma santé</h5>
              <p class="py-3">Vous faites confiance à votre pharmacien pour votre santé. Quels que soient vos besoins visuels, il vous apportera une réponse adaptée à votre correction et à vos besoins.</p>
              <a href="#" class="py-2 px-3 rounded-pill icone-color mt-3">En savoir plus</a>
            </div>
          </div>
          <div class="col-md-4">
            <div class="shadow-sm p-4 text-center mb-4  img-center" style="height: 400px;">
            </div>
          </div>
          <div class="col-md-4">
            <div class="shadow-sm p-4 text-center mb-4 box-hover" style="height: 400px;">
              <i class="fas fa-sync-alt i-fas mb-4 icone-color"></i>
              <h5 class="text-uppercase avenirltstd-light">Préservez vos yeux des UV</h5>
      ...
      <section class="container-fluid">
        <h2 class="text-uppercase text-title text-center pt-md-5 pb-4 mb-5">“Pour ma vue aussi, je demande conseil à mon Pharmacien”</h2>
        <div class="row">
          <div class="col-md-4">
            <div class="shadow-sm p-4 text-center mb-4 boder box-hover" style="height: 400px;">
              <i class="fas fa-sync-alt i-fas mb-4 icone-color"></i>
      ...
      <section class="container-fluid">
        <div class="row bg-hero pt-4 pb-5">
          <div class="col-md-12">
            <h2 class="text-uppercase p-5 text-white text-center avenirltstd-light">Jack Audio partenariat avec les meilleurs marques</h2>
          </div>
        </div>
      ...
      <section class="container-fluid bg-light py-5 px-3">
        <h2 class="text-uppercase p-5 text-title text-center avenirltstd-light">Contactez-nous</h2>
        <div class="row">
