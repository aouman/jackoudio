...
<html lang="fr" dir="ltr">
  ...
  <body>
    <header class="shadow" style="background-color: #fffc;">
        ...
        <div class="collapse navbar-collapse flex-column" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item mr-3 ml-3 avenirltstd-light">
              <a class="nav-link nav-text-responsive" href="/">Accueil <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item mr-3 ml-3 avenirltstd-light">
              <a href="/vous-etes-opticien" class="nav-link nav-text-responsive">Vous êtes opticien ?</a>
            </li>
            <li class="nav-item mr-3 ml-3 avenirltstd-light">
              <a href="/espace-franchise" class="nav-link nav-text-responsive">Espace franchise</a>
            </li>
            <li class="nav-item mr-3 ml-3  avenirltstd-light">
              <a href="/trouver-un-centre" class="nav-text-responsive nav-link">Trouver un centre</a>
            </li>
